        ...
        methods : {
            ...
            resizeImage64withCanvase : function (loadedFile, canvas) {
                ...
                return new Promise((resolve)=>{
                    ...
                    const MAX_SIZE = this.resizeUpperLimitPixel; // 縦横で長い方の最大値を指定する（例：28）とする
                    ...
                    if (image.width < MAX_SIZE && image.height < MAX_SIZE) {
                        ...
                        // リサイズして貼り付ける
                        console.log('ctx.ImageData is firstly:')
                        console.log(ctx.getImageData(0, 0, MAX_SIZE, MAX_SIZE));
                        //ctx.drawImage(image, 0, 0, image.width, image.height, 0, 0, dstWidth, dstHeight);
                        ctx.drawImage(image, 0, 0, image.width, image.height, 0, 0, dstWidth, dstHeight);
                    }
                    console.log('ctx.ImageData is:')
                    console.log(ctx.getImageData(0, 0, dstWidth, dstHeight));
